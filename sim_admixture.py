...
def main():
    ...
    os.system('/net/gs/vol1/home/aclark4/software/gemma' + \
                  ...
                  ' -notsnp' + \
                  ' -o ' + new_prefix + \
                  ' -c output/run13/admixture_output/admixture_covariates_8_pops.txt')
    os.system('mv output/' + new_prefix + '.assoc.txt output/' + new_prefix + '_whole_K_admixture.assoc.txt')

    print('admixture covariates with no K')
    os.system('Rscript sim_admixture.R ' + sys.argv[1])
    ...
    os.system('/net/gs/vol1/home/aclark4/software/gemma' + \
                  ...
                  ' -notsnp' + \
                  ' -o ' + new_prefix)
    os.system('mv output/' + new_prefix + '.assoc.txt output/' + new_prefix + '_whole_K.assoc.txt')
